...
This is a cellular automata map generator library based largely upon a 
...
The included test vectors demonstrate the use of the library, and dump the 
generated maps to the console in an ascii representation.

The library has no dependencies except for Python 2.7.X. It may work on Python
